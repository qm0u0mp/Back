package com.haneul.basic.provider;
...
// - 인증 및 인가에 사용
// - 암호화가 되어있어 클라이언트와 서버 간의 안전한 데이터 교환을 할 수 있음
// - 헤더, 페이로드, 서명으로 구성됨
...
public class JwtProvider {
    ...
    public String create(String principle) {
        ...
        // 비밀키 생성
        Key key = Keys
                .hmacShaKeyFor("qwerasdfzxcvqwerasdfzxcvqwerasdfzxcvqwerasdfzxcv".getBytes(StandardCharsets.UTF_8));
